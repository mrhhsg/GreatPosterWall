...
// Main settings
define('SITE_NAME', 'Gazelle Dev'); //The name of your site
define('SITE_HOST', 'localhost'); // The host for your site (e.g. localhost, orpheus.network)
...
define('ANNOUNCE_HTTP_URL', 'http://localhost:34000http://' . SITE_HOST . ':2710'); //Announce HTTP URL
define('ANNOUNCE_HTTPS_URL', 'https://localhost:3400http://' . SITE_HOST . ':2710'); //Announce HTTPS URL
...
$MemcachedServers = array(
    ...
    array('host' => 'memcached', 'port' => 11211, 'buckets' => 1),
);
